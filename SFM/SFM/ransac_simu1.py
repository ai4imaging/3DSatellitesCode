...
K = np.array([[1084, 0, 180], [0, 1084, 180], [0, 0, 1]])
match = get_matches(5, 6)
keypoints5 = keypoints[5]
keypoints6 = keypoints[6]

img1 = cv2.imread('simu1/masked/0000005.jpg')
img2 = cv2.imread('simu1/masked/0000006.jpg')
